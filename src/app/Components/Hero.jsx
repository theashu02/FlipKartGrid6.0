    ...
    >
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <motion.div className="mr-auto place-self-center lg:col-span-7" variants={itemVariants}>
          ...
          >
            <span className="font-consolas bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-600">
              Smart Vision Technology
            </span>
            <br />
            <span className="text-gray-800 font-consolas">
              Quality Control
            </span>
          </motion.h1>
          <motion.p
            className="max-w-2xl mb-6 font-light text-gray-700 font-raleway lg:mb-8 md:text-lg lg:text-xl"
            variants={itemVariants}
          >
